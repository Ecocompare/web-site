...
//	updateTotalRating();
	...
	/* debut fonctions pour demarche-ecocompare.html */
	function afficheOnglet (nbonglets, elm, idconteneur){
		var nom = "onglet";
		for (var i=1; i <= nbonglets ; i++){
			var monOnglet = document.getElementById(nom + i);
			monOnglet.className = 'onglet';
		}
		...
		conteneur.className = 'contenu_onglet';	
	}

	function ecocompare_lightbox(p_idshadowing, p_idbox){
		var idbox = p_idbox;
		var idshadowing = p_idshadowing;
		
		this.openbox = function(){
			var box = document.getElementById(idbox); 
			document.getElementById(idshadowing).style.display='block';
			box.style.display='block';	
		}

		this.closebox = function(){
			document.getElementById(idbox).style.display='none';
			document.getElementById(idshadowing).style.display='none';
		}
	}

	/* fin fonctions pour demarche-ecocompare.html */	
