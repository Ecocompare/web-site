<div itemscope itemtype="http://data-vocabulary.org/Product">
	...
	<div class="productheader">
		...
		<div class="badge">
			<img alt="<?=stripslashes($this->product['name'])?>" src="bilan-produit-eco-<?=toUrl($this->product['name'])?>-<?=$this->product['id']?>-<?=$this->lang?>.png"/>
		</div>
		...
		<span class="rating_system">
			<span class='rate_title'>Avis consommateurs</span>
			<div class='rate'>
				<?=$this->rateGlobal;
