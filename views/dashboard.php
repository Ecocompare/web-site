			...
			<? if ($even == false){ $class = "odd"; $even = true; }else{ $class = "even"; $even = false;} ?>
				...
				<td class="actions">
						...
						<? } ?>
							...
							<a href="javascript: duplicateProduct(<? echo $product['id'] ?>)" alt="Dupliquer"><img src="<?=$GLOBALS['base']?>style/duplicate.png" alt="Dupliquer"/></a>&nbsp;&nbsp; 

							<a href="javascript: deleteProduct(<? echo $product['id'] ?>)" alt="Supprimer"><img src="<?=$GLOBALS['base']?>style/delete.gif" alt="Modifier"/></a>
