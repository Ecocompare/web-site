...
<div>
	...
	<div class="formsection">
		...
		<form id="form" action="news?action=<? echo $this->targetAction; ?>" method="post" >
	...
	<!--	<form id="uploader" name="uploader" target="uploadiframe" action="news?action=upload" method="post" enctype="multipart/form-data">
	...
	<div class="formbuttons">
		<input type="button" onClick="prepareToSubmit(); document.getElementById('form').submit();" value="Enregistrer"/> ou <a href="news?action=admin">Annuler</a>
	</div>
</div>